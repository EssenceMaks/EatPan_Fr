...
- Модуль recipe_book_sector: ✅ Полностью перенесён из монолита
- API: 🟡 Mock данные (заглушка под Django)
- Другие секции (Hero, Kitchen, Supplies, Timetable): 🔲 Placeholder-контент

## Language Rules & Communication Skills
- **Коментарі в коді / Comments:** Писати ТІЛЬКИ українською або англійською мовою.
- **Спілкування / Communication:** Плани дій та звіти про виконану роботу потрібно генерувати внутрішньо англійською, а потім ПЕРЕКЛАДАТИ та видавати користувачеві УКРАЇНСЬКОЮ мовою (або одразу формувати відповідь українською).
