...
- **"Брудне" відображення кутів CSS Bento**: Замінено жорстко задані кольори фону (суцільні пікселі) у кутах заголовка (`arc-bento-full__corner-tr` та інших) на чисте наслідування масок та прозоростей. Це усунуло візуальні артефакти, що конфліктували із глобальним темним RPG-фоном сторінки.
- **Розмір іконок в ArcBentoHeaderFull**: Іконки (crown, gem) виходили за межі батьківського контейнера через дефолтний розмір 24px від бібліотеки lucide. Використано нативні можливості Lucide: додано width="14" height="14" атрибути безпосередньо в HTML теги <i>. Змінено layout з grid на flexbox для кращої адаптивності контейнера бейджів.
